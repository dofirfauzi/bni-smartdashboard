  ...
  <Dashboard>
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <div class="bg-white hover:bg-primary-50 p-4 rounded-lg shadow-lg">
        ...
        <p class="my-3 text-xl font-semibold">976,000,000.51</p>
        <p class="text-sm italic">Total Saldo</p>
      </div>
      <div class="bg-white hover:bg-primary-50 p-4 rounded-lg shadow-lg">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="my-3 text-xl font-semibold">976,000,000.51</p>
        <p class="text-sm italic">Total Giro</p>
      </div>
      <div class="bg-white hover:bg-primary-50 p-4 rounded-lg shadow-lg">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="my-3 text-xl font-semibold">.00</p>
        <p class="text-sm italic">Total Deposito</p>
      </div>
      <div class="bg-white hover:bg-primary-50 p-4 rounded-lg shadow-lg">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p class="my-3 text-xl font-semibold">37</p>
